...
export class MongoHelper {
  async createIndexes() {
    ...
    await contributionCollection.createIndex({ _id: 1, walletID: 1, symbol: 1, userID: 1, isActive: 1 })
    await withdrawalCollection.createIndex({ _id: 1, walletID: 1, symbol: 1, userID: 1, isActive: 1 })
    await contributionCollection.createIndex({ isActive: 1, userID: 1 })
    await withdrawalCollection.createIndex({ isActive: 1, userID: 1 })
