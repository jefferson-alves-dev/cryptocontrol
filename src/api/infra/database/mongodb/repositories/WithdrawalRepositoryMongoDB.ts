...
export class WithdrawalRepositoryMongoDB implements IWithdrawalRepository {
  ...
  async getById(withdrawalID: string, userID: string): Promise<TWithdrawalRepository.GetResult> {
    ...
    return {
      ...
      symbolCoinUsedForWithdrawal: withdrawals.symbolCoinUsedForWithdrawal,
      symbolWithdrawnCoin: withdrawals.symbolWithdrawnCoin,
      amountWithdrawn: withdrawals.amountWithdrawn,
      withdrawalBrokerFee: withdrawals.withdrawalBrokerFee,
      symbolCoinUsedForPayWithdrawalBrokerFee: withdrawals.symbolCoinUsedForPayWithdrawalBrokerFee,
